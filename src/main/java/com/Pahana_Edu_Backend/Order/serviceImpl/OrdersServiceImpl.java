...
//                 bill.append("Customer Phone: ").append(order.get().getCustomerPhone()).append("\n"); // Added
...
//                     productDetails.put("finalPrice", discountedPrice);
//                 } else {
//                     productDetails.put("name", "Product ID: " + productId + " (Not found)");
...
//         bill.put("orderDate", order.getOrderDate().toString());
//         bill.put("productType", order.getProductType());
...
//             document.add(new Paragraph("Product Type: " + order.getProductType()));
//             document.add(new Paragraph("Status: " + order.getStatus()));

//             // Add product table
//             Table table = new Table(new float[]{200, 100, 100, 100});
...
//                         totalDiscount += price * (discount / 100);
//                         totalPriceBeforeDiscount += price;
//                         table.addCell(new Cell().add(new Paragraph(book.get().getTitle())));
...
//                         table.addCell(new Cell().add(new Paragraph(String.format("%.2f", discountedPrice))));
//                     } else {
//                         table.addCell(new Cell().add(new Paragraph("Product ID: " + productId + " (Not found)")));
...
//                         totalDiscount += price * (discount / 100);
//                         totalPriceBeforeDiscount += price;
//                         table.addCell(new Cell().add(new Paragraph(accessory.get().getItemName())));
//                         table.addCell(new Cell().add(new Paragraph(String.format("%.2f", price))));
//                         table.addCell(new Cell().add(new Paragraph(String.format("%.2f", discount))));
//                         table.addCell(new Cell().add(new Paragraph(String.format("%.2f", discountedPrice))));
//                     } else {
...
//             // Add totals
//             document.add(new Paragraph("Total Price Before Discount: $" + String.format("%.2f", totalPriceBeforeDiscount)));
//             document.add(new Paragraph("Total Discount: $" + String.format("%.2f", totalDiscount)));
//             document.add(new Paragraph("Final Total Price: $" + String.format("%.2f", order.getTotalPrice())));
...
//     @Override
//     public Orders createOrder(Orders order) {
//         if (order.getProductIds() != null && order.getProductTypes() != null) {
//             for (String productId : order.getProductIds()) {
...
//                 }
//                 if (productType.equals("Book") && !bookRepository.existsById(productId)) {
//                     throw new IllegalArgumentException("Book with ID " + productId + " not found");
//                 } else if (productType.equals("Accessory") && !accessoriesRepository.existsById(productId)) {
...
//         List<String> productIds = order.get().getProductIds() != null ? order.get().getProductIds() : new ArrayList<>();
...
//                         .append(")\n");
//                 } else {
//                     bill.append("  - Book ID: ").append(productId).append(" (Not found)\n");
//                 }
...
//                         .append(")\n");
//                 } else {
//                     bill.append("  - Accessory ID: ").append(productId).append(" (Not found)\n");
//                 }
//             } else {
//                 bill.append("  - Product ID: ").append(productId).append(" (Unknown product type)\n");
//             }
//         }

//         bill.append("Total Price Before Discount: $").append(String.format("%.2f", totalPriceBeforeDiscount)).append("\n")
//             .append("Total Discount: $").append(String.format("%.2f", totalDiscount)).append("\n")
//             .append("Final Total Price: $").append(String.format("%.2f", order.get().getTotalPrice())).append("\n")
...
//                             .append(")<br>");
//                     } else {
//                         productDetails.append("Book ID: ").append(productId).append(" (Not found)<br>");
//                     }
//                 } else if (productType.equals("Accessory")) {
//                     Optional<Accessories> accessory = accessoriesRepository.findById(productId);
//                     if (accessory.isPresent()) {
...
//                             .append(")<br>");
//                     } else {
//                         productDetails.append("Accessory ID: ").append(productId).append(" (Not found)<br>");
//                     }
//                 } else {
//                     productDetails.append("Product ID: ").append(productId).append(" (Unknown product type)<br>");
//                 }
//             }
...
//                     table.addCell(new Cell().add(new Paragraph(String.format("%.2f", discount))));
//                     table.addCell(new Cell().add(new Paragraph(String.format("Rs. %.2f", discountedPrice))));
//                 } else {
